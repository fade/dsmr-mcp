...
file-based ICP as a fallback for crash isolation and parallel workers."
  ...
  :depends-on ("alexandria"
               ...
               "dsmr-mcp/src/tools/status-fields"
               "dsmr-mcp/src/tools/pool-status"
               "dsmr-mcp/src/tools/pool-kill-worker"
               "dsmr-mcp/src/tools/attach-reset"
               "dsmr-mcp/src/tools/backend-status"
               "dsmr-mcp/src/reset"
...
(asdf:defsystem "dsmr-mcp/tests"
  ...
  :depends-on ("zebra"
               ...
               "dsmr-mcp/tests/bus/status-test"
               ...
               "dsmr-mcp/tests/tools/status-fields-test"
               "dsmr-mcp/tests/tools/bus-roster-test"
               "dsmr-mcp/tests/tools/bus-addressing-test"
               "dsmr-mcp/tests/tools/attach-reset-test"
               "dsmr-mcp/tests/tools/backend-status-test"
               "dsmr-mcp/tests/tools/bus-inspect-test"
...
(asdf:defsystem "dsmr-mcp/tests/integration"
  ...
  :depends-on ("zebra"
               ...
               "dsmr-mcp/tests/integration/attach/liveness-wedge-test"
               "dsmr-mcp/tests/integration/attach/reset-race-test"
               ...
               "dsmr-mcp/tests/integration/hermetic/liveness-wedge-test"
