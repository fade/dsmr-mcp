...
case $leader in
    valis)
        ...
        # scanning it is safe. boomer and xxx-pure-tls live outside it.
        #
    ...
    dsmr-mcp)
        ...
        args=(--no-scan --extra dsmr-mcp,mallet,boomer,xxx-pure-tls,sbcl,zebra --stagger 3-10)
        ...
        MEMBERS=(dsmr-mcp mallet boomer xxx-pure-tls sbcl zebra)
        SCAN_MEMBERS=0
        EXCLUDE_MEMBER=
        ;;
    '')
